...
<!-- Sekarang render view dengan data yang sudah safe -->
...
<section class="section">
    <div class="card">
        <div class="card-header">
            ...
            <p class="text-muted">Kelola dan pantau koleksi motor Anda dengan filter yang mudah digunakan</p>
        </div>
        <div class="card-body">
            <!-- Filter Section -->
            <form action="<?= base_url('pemilik/motor/catalog') ?>" method="GET" class="mb-4" id="filterForm">
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6 col-lg-2">
                        <label class="form-label">Status</label>
                        <a href="<?= base_url('pemilik/motor/catalog') ?>" class="btn btn-secondary form-control">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 mb-4">
                            <div class="card h-100 shadow-sm hover-shadow-lg transition-all" style="cursor: pointer; transition: all 0.3s ease;">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <!-- Tanggal Masuk -->
                                    <?php if (!empty($motor['tanggal_masuk'])): ?>
                                        <small class="text-muted d-block mb-3">
                                            <i class="iconly-boldCalendar"></i>
                                            <?= date('d/m/Y', strtotime($motor['tanggal_masuk'])) ?>
                                        </small>
                                    <?php endif; ?>

                                    <!-- Action Buttons -->
                                    <div class="d-flex gap-2 mt-auto">
                                        <a href="<?= base_url('pemilik/motor/' . ($motor['id'] ?? '#')) ?>" class="btn btn-outline-primary flex-fill" title="Detail">
                ...
                <?php else: ?>
                    <div class="col-12">
                        <div class="alert alert-info text-center py-5">
                            ...
                            <a href="<?= base_url('pemilik/motor/catalog') ?>" class="btn btn-primary btn-sm mt-3">
                                <i class="iconly-boldRefresh"></i> Reset Filter
                            </a>
                        </div>
                    </div>
